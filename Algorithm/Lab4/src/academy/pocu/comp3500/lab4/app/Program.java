...
public class Program {
    public static void main(String[] args) {
        ...
        RainbowTable[] emptyTables = new RainbowTable[] {
        };
...

        {
            String[] test = new String[] {
                    "yiRNCBNQgQETz6+ieP/VgQ==",
                    "EfIl0sd6mcLoS45wACqTUg==",
                    "wssIXCT4UJhuVfHESr5odg==",
                    "8DiBqIxuORNfDsxg79YJuQ==",
            };

            byte[] passHashBytes = Cracker.getHash(password, "md2");
            String passHash = new String(Base64.getEncoder().encode(passHashBytes), StandardCharsets.UTF_8);
            System.out.println("MD2: " + passHash);
...

        {
            String[] test = new String[] {
                    ...
                    "DRB9CfW75Ayt495ccenptw==",
                    "2FeO34RYzgb7xbt2pYxcpA==",
                    "X03MO1qnZdYdgyfeuILPmQ==",
            };

            byte[] passHashBytes = Cracker.getHash(password, "md5");
            String passHash = new String(Base64.getEncoder().encode(passHashBytes), StandardCharsets.UTF_8);
            System.out.println("MD5: " + passHash);

            System.out.println(MessageDigest.isEqual(passHashBytes, Cracker.getHash("0000", "md5")));
            System.out.println(MessageDigest.isEqual(passHashBytes, Cracker.getHash("letmein", "md5")));
            System.out.println(MessageDigest.isEqual(passHashBytes, Cracker.getHash("qwerty", "md5")));
            System.out.println(MessageDigest.isEqual(passHashBytes, Cracker.getHash("password", "md5")));
        }

        {
            ...
            String[] plainTexts = cracker.run(emptyTables);
