...
int main(void)
{
    ...
    version = get_character("data/Superman_v1.txt", &superman_v1);
    assert(version == 1);
    ...
    version = get_character("data/Batman_v2.txt", &batman_v2);
    assert(version == 2);
    ...
    version = get_character("data/Flash_v3.txt", &flash_v3);
    assert(version == 3);
    ...
    version = get_character("data/Wonderwoman_v3.txt", &wonderwoman_v3);
    assert(version == 3);
