...
namespace Assignment1
{
    class Program
    {
        ...
        static void ToBinaryTest()
        {
            ...
            string test1 = BigNumberCalculator.ToDecimalOrNull("0b0");
            string test2 = BigNumberCalculator.ToDecimalOrNull("0b1");

            string test3 = BigNumberCalculator.ToHexOrNull("0b0");
            string test4 = BigNumberCalculator.ToHexOrNull("0b1");
